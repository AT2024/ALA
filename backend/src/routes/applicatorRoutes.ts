...
} from "../middleware/uuidValidationMiddleware";
...
router.get(
  "/treatment/:treatmentId/seed-status",
  validateUUID("treatmentId"),
  databaseHealthCheck,
  getSeedStatus,
);
...
router.patch(
  "/treatments/:treatmentId/applicators/:id",
  validateMultipleUUIDs(["treatmentId", "id"]),
  criticalOperationHealthCheck,
  updateApplicator,
);
...
router.post(
  "/treatments/:treatmentId/package",
  validateUUID("treatmentId"),
  criticalOperationHealthCheck,
  createPackage,
);
router.get(
  "/treatments/:treatmentId/packages",
  validateUUID("treatmentId"),
  databaseHealthCheck,
  getPackages,
);
