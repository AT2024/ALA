...
type TreatmentPdfCreationAttributes = Optional<
  TreatmentPdfAttributes,
  "id" | "emailSentAt" | "emailSentTo" | "emailStatus"
>;

class TreatmentPdf
  extends Model<TreatmentPdfAttributes, TreatmentPdfCreationAttributes>
  implements TreatmentPdfAttributes
{
  public id!: string;
