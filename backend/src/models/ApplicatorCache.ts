...
type ApplicatorCacheCreationAttributes = Optional<
  ApplicatorCacheAttributes,
  | "SIBD_NOUSE"
  | "SIBD_EXPIRY"
  | "SIBD_TREATTYPE"
  | "SIBD_SEEDQTY"
...
class ApplicatorCache
  extends Model<ApplicatorCacheAttributes, ApplicatorCacheCreationAttributes>
  implements ApplicatorCacheAttributes
{
