...
describe("PhiEncryption", () => {
  ...
  describe("Encrypt/Decrypt", () => {
    ...
    it("should throw if not initialized when decrypting", async () => {
      const encryption = new PhiEncryption();
      await expect(encryption.decrypt("test")).rejects.toThrow(
        "Encryption not initialized",
      );
    });
...
describe("IndexedDbService", () => {
  ...
  describe("Treatment Operations", () => {
    ...
    it("should get all downloaded treatments", async () => {
      ...
      const treatment1 =
        createMockTreatment() as unknown as import("../../../src/services/indexedDbService").OfflineTreatment;
      const treatment2 =
        createMockTreatment() as unknown as import("../../../src/services/indexedDbService").OfflineTreatment;
    ...
    it("should delete treatment and cascade to applicators", async () => {
      ...
      const treatment =
        createMockTreatment() as unknown as import("../../../src/services/indexedDbService").OfflineTreatment;
      const applicators = createApplicatorSet(
        treatment.id,
        3,
      ...
      expect(
        (await service.getApplicatorsByTreatment(treatment.id)).length,
      ).toBe(3);
    ...
    it("should return true for expired treatment", async () => {
      ...
      const expired =
        createExpiredTreatment() as unknown as import("../../../src/services/indexedDbService").OfflineTreatment;
  ...
  describe("Pending Changes Operations", () => {
    it("should add pending change and return auto-incremented ID", async () => {
      ...
      const change =
        createMockPendingChange() as unknown as import("../../../src/services/indexedDbService").PendingChange;
    ...
    it("should get only pending status changes", async () => {
      ...
      const pending = createMockPendingChange({
        status: "pending",
      }) as unknown as import("../../../src/services/indexedDbService").PendingChange;
      const syncing = createMockPendingChange({
        status: "syncing",
      }) as unknown as import("../../../src/services/indexedDbService").PendingChange;
      const failed = createMockPendingChange({
        status: "failed",
      }) as unknown as import("../../../src/services/indexedDbService").PendingChange;
    ...
    it("should return pending changes count", async () => {
      ...
      await service.addPendingChange(
        createMockPendingChange() as unknown as import("../../../src/services/indexedDbService").PendingChange,
      );
      await service.addPendingChange(
        createMockPendingChange() as unknown as import("../../../src/services/indexedDbService").PendingChange,
  ...
  describe("Conflict Operations", () => {
    it("should add conflict and return ID", async () => {
      ...
      const conflict =
        createMockConflict() as unknown as import("../../../src/services/indexedDbService").OfflineConflict;
    ...
    it("should get admin-required conflicts", async () => {
      ...
      const normal = createMockConflict({
        requiresAdmin: false,
      }) as unknown as import("../../../src/services/indexedDbService").OfflineConflict;
      const admin = createMockConflict({
        requiresAdmin: true,
      }) as unknown as import("../../../src/services/indexedDbService").OfflineConflict;
  ...
  describe("Data Management", () => {
    ...
    it("should return all storage stats", async () => {
      ...
      await service.saveApplicator(
        createMockApplicator() as unknown as import("../../../src/services/indexedDbService").OfflineApplicator,
      );
      await service.addPendingChange(
        createMockPendingChange() as unknown as import("../../../src/services/indexedDbService").PendingChange,
      );
  ...
  describe("Singleton", () => {
    it("should export a singleton instance", async () => {
      const { offlineDb } =
        await import("../../../src/services/indexedDbService");
