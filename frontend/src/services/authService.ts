        ...
        switch (status) {
          case 404:
            return {
              success: false,
              message:
                "User not found in the Priority system. Please contact the ATM team to set up your account.",
            };
          case 401:
            return {
              success: false,
              message:
                "Access denied. Your account may not have the necessary permissions.",
            };
          case 403:
            return {
              success: false,
          ...
          case 500:
            return {
              success: false,
              message:
                "System error while connecting to Priority. Please try again or contact support.",
            };
          case 503:
            return {
              success: false,
              message:
                "Priority system is temporarily unavailable. Please try again later.",
            };
          default:
            return {
              success: false,
