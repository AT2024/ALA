...
export class PDFService {
  static generateTreatmentReport(
    ...
    doc.setFontSize(12);
    doc.text(`Generated: ${format(new Date(), "dd.MM.yyyy HH:mm")}`, 105, 42, {
      align: "center",
    });
    ...
    if (finalY + 80 > pageHeight - 40) {
      // 80 for summary content + 40 for margins/footer
      doc.addPage();
      doc.setFontSize(16);
    ...
    const summaryTableData = [
      [
        ...
        summary.timeInsertionStarted &&
        !isNaN(new Date(summary.timeInsertionStarted).getTime())
      ...
      ["Not Used Applicators:", summary.notUsedApplicators.toString(), "", ""],
    ];
    ...
    doc.setFontSize(10);
    doc.text(
      "Generated by Accountability Log Application",
      105,
  ...
  static generateApplicatorReport(applicators: Applicator[]): void {
    ...
    doc.setFontSize(12);
    doc.text(`Generated: ${format(new Date(), "dd.MM.yyyy HH:mm")}`, 105, 30, {
      align: "center",
    });
