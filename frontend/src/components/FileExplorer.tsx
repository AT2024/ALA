  ...
  const projectFiles: FileNode[] = [
    {
      ...
      children: [
          ...
          children: [
            ...
            { name: "package.json" },
            {
              ...
              children: [
                {
                  name: "config",
                  children: [{ name: "database.ts" }],
                },
                {
                  name: "controllers",
                  children: [{ name: "authController.ts", highlight: true }],
                },
                {
                  name: "middleware",
                  children: [
        ...
        {
          name: "scripts",
          children: [{ name: "debug.js", highlight: true }],
        },
      ],
    },
  ];
