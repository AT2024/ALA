...
export function OfflineDownloadButton({
  ...
  const [state, setState] = useState<DownloadState>(
    isDownloaded(treatmentId) ? "downloaded" : "not_downloaded",
  );
    ...
    try {
      ...
      if (!offlineDb.isEncryptionReady()) {
        ...
        if (derivedKey) {
          ...
          console.warn(
            "[OfflineDownloadButton] No encryption key available - data will not be encrypted",
          );
        }
      }
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-100 mt-1">
                Don't close the app while working offline. Your changes will
