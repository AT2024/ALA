      ...
      <div className="mx-4 w-full max-w-md rounded-lg bg-white shadow-xl">
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">{applicatorSerial}</p>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="px-4 py-4">
          <div className="mb-4 flex items-start gap-3 rounded-lg bg-yellow-50 p-3">
            ...
            <div className="text-sm text-yellow-800">
              ...
              <p className="mt-1">
                You are about to mark this applicator as{" "}
                <strong>{status}</strong> while offline.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li className="flex items-start gap-2">
                <CheckCircle className="mt-0.5 h-4 w-4 flex-shrink-0 text-green-500" />
                <span>
                  When you reconnect, the change will be synced to the server
                </span>
              </li>
              <li className="flex items-start gap-2">
                <AlertTriangle className="mt-0.5 h-4 w-4 flex-shrink-0 text-yellow-500" />
                <span>
                  This action will be flagged for verification during sync
                </span>
              </li>
              {isInserted && (
                <li className="flex items-start gap-2">
                  <AlertTriangle className="mt-0.5 h-4 w-4 flex-shrink-0 text-yellow-500" />
                  <span>
                    If there&apos;s a conflict, an administrator will need to
                    resolve it
                  </span>
                </li>
              )}
          ...
          <label className="mt-4 flex cursor-pointer items-start gap-3 rounded-lg border border-gray-200 p-3 hover:bg-gray-50">
            ...
            <span className="text-sm text-gray-700">
              I understand that I am marking this applicator as{" "}
              <strong>{status}</strong> while offline, and this action will be
              synced and verified when I reconnect.
            </span>
          </label>
        </div>
