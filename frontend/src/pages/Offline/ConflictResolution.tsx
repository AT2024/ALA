        ...
        {conflicts.length === 0 ? (
          ...
          <div className="space-y-4">
            {conflicts.map((conflict) => {
              ...
              return (
                <div key={conflict.id} className="rounded-lg bg-white shadow">
                  {/* Conflict header */}
                  <div
                    className={cn(
                    ...
                    <table className="w-full text-sm">
                      <thead className="bg-gray-50">
                        <tr>
                          ...
                          <th className="px-4 py-2 text-left font-medium text-primary">
                            Your Change
                          </th>
                          <th className="px-4 py-2 text-left font-medium text-green-600">
                            Server Value
                          </th>
                        </tr>
                      </thead>
                        ...
                        {changes.map((change, idx) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-2 text-primary">
                              {formatValue(change.local)}
                            </td>
                            <td className="px-4 py-2 text-green-700">
                              {formatValue(change.server)}
                            </td>
                          </tr>
                        ))}
                      </tbody>
