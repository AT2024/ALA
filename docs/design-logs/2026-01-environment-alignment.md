...
**Documented (Comments/Guides Added):** 5. ✅ **Gap #2**: Added comment in `docker-stack.yml` explaining dumb-init workaround 6. ✅ **Gap #3, #4, #6**: Documented service naming differences 7. ✅ **Gap #5**: Added restart policy documentation to `SWARM_OPERATIONS.md` 8. ✅ **Gap #9, #10, #12**: Documented in this design log
